    ...
    @foreach($rents as $rent)
        <tr>
            ...
            <td>
                ...
                <a href="{{ route('rents.destroy',$rent->id) }}" onclick="return confirm('¿Está seguro que desea cancelar el alquiler?')" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
